...
public interface ClientesClient {
  /**
   * Llama a GET
   * /api/v1/clientes?tipoIdentificacion=CEDULA&numeroIdentificacion=0102020202
  ...
  @PostMapping("/{cedulaCliente}/cuentas/ahorros")
  void crearCuentaAhorros(@PathVariable("cedulaCliente") String cedulaCliente);
